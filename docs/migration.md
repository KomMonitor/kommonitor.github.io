...
that contain special characters. In particular, backslashed `\` produce such errors. Therefore, clean the CSV files containing such characters.
After succesfull migration you can set the original string again via KomMonitor Admin UI.
