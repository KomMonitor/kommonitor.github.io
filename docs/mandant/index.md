...
| **[Bedienungsanleitung (Stand Ende 2024)](./KomMonitor_Guide_Mandantenfähigkeit.pdf)** | PDF Dokumentation der Mandantenfähigkeit von KomMonitor inklusive detaillierten Bedienhinweisen zur Anwendung des Mandantenkonzepts und des Einrichtens von Usergruppen und Zugriffsrechten. |

<!-- ## 🚀 Kernkonzepte
* **Keine automatische Vererbung**: Rechte müssen explizit vergeben werden.
* **Ownership-Prinzip**: Gruppen haften für ihre Daten.
* **Hybrid-Modell**: Kombination aus Isolation und Synergie. -->